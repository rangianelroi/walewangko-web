    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                ...
                <form method="POST" action="{{ route('admin.salam_kumtuas.update', $salamKumtua) }}" enctype="multipart/form-data"> 
                    @csrf   
                    @method('PUT')
                    <div>
                        <x-input-label for="nama_hukum_tua" :value="__('Nama Hukum Tua')" />
                        <x-text-input id="nama_hukum_tua" class="block mt-1 w-full" type="text" name="nama_hukum_tua" :value="old('nama_hukum_tua', $salamKumtua->nama_hukum_tua)" required autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="pesan" id="pesan" class="editor border border-slate-300 rounded-xl w-full">{{ old('pesan', $salamKumtua->pesan) }}</textarea>
