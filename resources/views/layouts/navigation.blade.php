        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('admin.hero_sections.index')">
                                    {{ __('Walewangko Section') }}
                                <x-dropdown-link :href="route('admin.salam_kumtuas.index')">
                                    {{ __('Salam Hukum Tua') }}
                                </x-dropdown-link>
                                </x-dropdown-link>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('admin.umkm.index')">
                                    {{ __('UMKM') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    ...
                    <x-nav-link :href="route('admin.peta.index')" :active="request()->routeIs('admin.peta.index')">
                        {{ __('Peta') }}
                    </x-nav-link>
